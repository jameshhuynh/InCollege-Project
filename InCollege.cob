       >>SOURCE FORMAT FREE
       *> IDAHO-5: Combined Account System + Login Menu + Profile Management
       ...
       CREATE-EDIT-PROFILE.
           ...
           PERFORM VARYING WS-I FROM 1 BY 1 UNTIL WS-I > 3
              DISPLAY "Add Education (optional, max 3 entries. Enter 'DONE' to finish): " WITH NO ADVANCING
              ACCEPT WS-INPUT-LINE
              IF WS-INPUT-LINE(1:4) = "DONE"
                 EXIT PERFORM
              ELSE
       ...
       LOAD-PROFILE-FOR-USER.
           MOVE SPACES TO PF-FIRST-NAME PF-LAST-NAME PF-UNIVERSITY PF-MAJOR PF-ABOUT-ME
           MOVE 0 TO PF-GRAD-YEAR PF-EXP-COUNT PF-EDU-COUNT
           PERFORM VARYING WS-I FROM 1 BY 1 UNTIL WS-I > 3
              MOVE SPACES TO PF-EXP-TITLE(WS-I) PF-EXP-COMPANY(WS-I)
              MOVE SPACES TO PF-EXP-DATES(WS-I) PF-EXP-DESC(WS-I)
              MOVE SPACES TO PF-EDU-DEGREE(WS-I) PF-EDU-UNIV(WS-I) PF-EDU-YEARS(WS-I)
           END-PERFORM
       ...
       PARSE-PROFILE-REC.
           ...
           INTO PF-USERNAME, PF-FIRST-NAME, PF-LAST-NAME, PF-UNIVERSITY,
                PF-MAJOR, WS-INPUT-LINE, PF-ABOUT-ME,
                PF-EXP-COUNT,
                PF-EXP-TITLE (1), PF-EXP-COMPANY (1), PF-EXP-DATES (1), PF-EXP-DESC (1),
                PF-EXP-TITLE (2), PF-EXP-COMPANY (2), PF-EXP-DATES (2), PF-EXP-DESC (2),
                PF-EXP-TITLE (3), PF-EXP-COMPANY (3), PF-EXP-DATES (3), PF-EXP-DESC (3),
                PF-EDU-COUNT,
                PF-EDU-DEGREE (1), PF-EDU-UNIV (1), PF-EDU-YEARS (1),
                PF-EDU-DEGREE (2), PF-EDU-UNIV (2), PF-EDU-YEARS (2),
                PF-EDU-DEGREE (3), PF-EDU-UNIV (3), PF-EDU-YEARS (3)
           END-UNSTRING.
           IF WS-INPUT-LINE IS NUMERIC
               MOVE WS-INPUT-LINE TO PF-GRAD-YEAR
           END-IF.
       ...
       FIND-SOMEONE-OPTION.
           MOVE "*** UNDER CONSTRUCTION ***" TO WS-DISPLAY-MESSAGE
           PERFORM WRITE-OUTPUT-AND-DISPLAY
